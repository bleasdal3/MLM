...
use App\Http\Controllers\Import\MailFilters\APlaceInTheSun\EnquiryController;

class APlaceInTheSunController extends IncomingController
{
    private $sourced_from = "leads@aplaceinthesun.com";
    private $source_folder = "INBOX";
    private $destination_folder = "INBOX/Done/A Place in the Sun/systematicallytransacted";
    protected $source = "Portal";
    protected $sub_source = "A Place In The Sun";
    ...
    public function processMailItems()
    {
        ...
        foreach($inboxMailItems as $inboxMailItem)
        {
            ...
            if($count > $batch_size)
            {
                dd("Count exceeds batch size - APITS");
                break;
            }
        }
    }
